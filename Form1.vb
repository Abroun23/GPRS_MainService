...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Appver = "Version:94.0110.00"
        WriteVersion(Appver)
        WriteSocket("================================================================================", 0)
        WriteSocket("                                 DCS_Main is Start", 0)
        WriteSocket("================================================================================", 0)
    ...
    Public WithEvents Server As New TCPServer("8097", 1000, 1000)
#Region "Write"
...
#Region "Socket"
    Public Sub DataArrival(ByVal ClientID As Integer, ByVal Data As String, ByVal ip As String) Handles Server.DataArival
        ...
        Try
            ...
            If buffer(ClientID).Contains("CONNECT") Then
                WriteSocket(buffer(ClientID), ClientID)
                '[00010][ARASH] CONNECT
                '[40749][Tehran] CONNECT
                '[40777][ARASHRTU][10] CONNECT
                '[40708][RTU1001][2]CONNECT->
                ...
                '   WriteLogs(StationName, ClientID, 11111)
                ...
                If ObjectID = -1 Then
                    ...
                    If strsplit.Length > 3 Then
                        ...
                        ElseIf buffer(ClientID).Contains(">") Then
                            HasAlarm = True
                        End If
                        WriteLogs("HasAlarm:" & HasAlarm, ClientID, LoggerType(ObjectID).StationCode)
                ...
                Else
                    ...
                    Else
                        LoggerType(ObjectID).IsReadFromRTU = False
                        WritePORT("IsReadFromRTU:" & LoggerType(ObjectID).IsReadFromRTU, ClientID)
                    End If
                    Try
                        Dim index1 As Integer = strsplit(3).IndexOf("]")
                        Dim UnreadLog As String = Mid(strsplit(3), 1, index1)
    ...
    End Function
    Public Function GetInsertLogsFromLogFileToDB(ByVal RATLogID As String, ByVal FullFileName As String, ByVal Manual As Boolean, ByRef StartTime As DateTime, ByRef EndTime As DateTime) As Long
        '8

        GetInsertLogsFromLogFileToDB = GetInsertLogsFromLogFileToICSDB(RATLogID, FullFileName, Manual, StartTime, EndTime)
    ...
    Public Function CheckDateTimeFormat(ByVal _strTime As String, ByVal _strDate As String) As Boolean
        ...
        End Try
    End Function
    Public Function GetInsertLogsFromLogFileToICSDB(ByVal RATLogID As String, ByVal FullFileName As String, ByVal Manual As Boolean, ByRef StartTime As DateTime, ByRef EndTime As DateTime) As Long
        'p8
        ...
        End Try
    End Function
    Public Function ReadLogs(ByVal RealFile As String, ByVal StationCode As String)
        ...
        Try
            ...
            Catch ex As Exception
                '        WriteDCSLog("insert rat error " & ex.Message)
            End Try
            '   WriteDCSLog("RatID is " & lngRATLogID)
            Dim Stime, ETime As DateTime
            If lngRATLogID >= 0 Then

                GetInsertLogsFromLogFileToDB(lngRATLogID, RealFile, True, Stime, ETime)
    ...
    Private Sub RTU_Final_File_Generated(ByVal ObjectID As Integer, ByVal RealFileName As String, ByVal stationCode As Long) ' Handles RTUPort.RTU_Final_File_Generated
        ReadLogs(RealFileName, stationCode)
    End Sub
    Private Sub RTU_Synchronized(ByVal objectID As Integer, ByVal vendor As String, ByVal MemoryActive As Boolean)
        Try
            ...
            'Try
            '    LoggerType(objectID).DataFolder = (thies() & "\" & LoggerType(objectID).StationCode & "\").Replace("\\", "\")
